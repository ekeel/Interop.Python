...
namespace Ekeel.Interop.Python;

/// <summary>
/// Class <c>Handler</c> handles execution of Python scripts using a local Python setup.
/// </summary>
public class Handler
{
    /// <summary>
    /// This constructor initializes a new <c>Handler</c> using a .env file.
    /// </summary>
    public Handler()
    {
        Env.LoadEnvFile(".env");
    ...
    public Handler(string pythonDllPath)
    {
    ...
    public Handler(string pythonDllPath, string pythonHome)
    {
        Runtime.PythonDLL = pythonDllPath;
